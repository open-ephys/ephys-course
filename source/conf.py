...
man_pages = [(main_doc, "oe_eea_docs", "Open Ephys EEA Materials", [author], 1)]
...
texinfo_documents = [
    (
        main_doc,
        "Open Ephys Extracellular Electrophysiology Acquisition Materials",
        "Open Ephys Extracellular Electrophysiology Acquisition Materials",
        author,
        "Open Ephys Extracellular Electrophysiology Acquisition Materials",
        "Description",
...
html_theme_options = {
    ...
    'icon_links': [
        dict(name='GitHub',
             url='https://github.com/open-ephys/oe-ephys-course',
             icon='fab fa-github'),
        dict(name='Twitter',
             url='https://twitter.com/openephys',
             icon='fab fa-twitter'),
        dict(name='Discord',
             url='https://discord.gg/2F57u8jy44',
             icon='fab fa-discord')
    ],
