...
Here is that circuit https://tinyurl.com/yfukn585 with shunt capacitance added of 100 pF.

A. What is shunt capacitance?

B. What % of our signal are we losing between Vec and Vin? Why?

C. What could we change to increase the signal at Vin?

.. note::
  The capacitor of our electrode and the shunt capacitance are forming a voltage divider.

D. The tips of certain electrodes, e.g. nichrome tetrodes, can be electroplated in a thin layer of gold. This 'goldplating' increases the surface area of the tip, creating more space to separate charge. This increases tip capacitance by around 100x. Make this change in the circuit. How similar are Vec and Vin now?

.. note::
  gold plated electrode: https://tinyurl.com/yf5tlhf4

Drawing Current
##############################################
Let's do a recording! We take our electrode, and attach it through a long wire to a recording system (the recording system has an analog to digital converter, ADC, and a recording computer).

https://tinyurl.com/yjw8aser

A. How much of the voltage at the electrode, Vec, are we recording at Vout?

B. Place an ideal operational amplifier between the electrode and the long wire. What happens to Vout? Why?
...
C. Change the circuit to stop the amplifier from saturating. What is the amplifier gain now?

.. note::
  https://tinyurl.com/yhehjxep Connect the amplifier output to the inverting input. Now we’re just seeing our input signal replicated at the output of the amplifier with a gain of 1.
...
.. note::
  Optional exercise: Make version more similar to ephys signals by using a sinewave:
  - Send sinewave to pin A14 (connect to wire)
  - make it faster (about 20 Hz)
